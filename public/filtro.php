...
$colores_map = [
    ...
    'Verde'  => '#556B2F', 'Marrón' => '#8B4513', 'Multicolor' => 'linear-gradient(45deg, red, blue, yellow)'
];
    ...
    <aside class="sidebar">
        <form method="GET">
            ...
            <div class="filter-group">
                ...
                <input type="range" name="precio" min="0" max="5000" step="50" value="<?= $_GET['precio'] ?? '2000' ?>" id="p-range">
                <div class="filter-group">
